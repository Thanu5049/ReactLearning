                            ...
                            <fieldset>
                                ...
                                <div style={{ display: "flex", justifyContent: "space-between",padding:"10px",alignItems:"center",padding:"20px 70px" }}>
                                    <div>
                                        ...
                                        <div style={{ fontWeight: "700",display:"flex",alignItems:"center" ,gap:"5px",border:"1px solid grey",marginTop:"10px"}}>
                                            <img src='ticketLogo.png' style={{marginLeft:"5px"}}/>
                                            <input type="text" placeholder='Enter your ticket number' style={{height:"40px",width:"200px",border:"none"}} />
                                        </div>
                                    </div>

                                    <div style={{marginLeft:"60px",marginTop:"30px"}}>
                                    <Button variant="danger" style={{height:"40px",width:"100px",borderRadius:"0px",}}> SUBMIT</Button>
                                    </div>
                                </div>
                            </fieldset>
                        </div>
